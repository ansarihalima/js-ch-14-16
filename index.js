...
let fruit = ['apple', 'Mango', 'lychee', 'peach'];
...
var qualificationInPakistan = ["SSC", "HSC", "BCS", "BS", "B.COM", "MS", "M.Phil", "PHD"];
...
for (let i = 0; i < studentNames1.length; i++) {
    ...
    document.write(`Score of ${studentNames1[i]} is ${scores[i]}. Percentage is ${percentage}%`);
}
